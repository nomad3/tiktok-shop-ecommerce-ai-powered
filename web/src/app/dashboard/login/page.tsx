  ...
  return (
    <div className="min-h-screen bg-tiktok-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-tiktok-dark rounded-2xl p-8 border border-tiktok-gray">
          {/* Logo */}
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-gradient-to-br from-tiktok-cyan to-tiktok-red rounded-2xl flex items-center justify-center">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">
              Sign in to access your AI-powered e-commerce dashboard
            </p>
          </div>
