...
function SuggestionCard({
  ...
  return (
    <div className="bg-tiktok-dark rounded-xl border border-tiktok-gray overflow-hidden hover:border-tiktok-gray/80 transition-colors">
      <div className="p-6">
        {/* Header */}
        ...
        {suggestion.ai_reasoning && (
          <div className="bg-tiktok-gray/50 rounded-lg p-4 mb-4">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-tiktok-cyan">AI Analysis</span>
            </div>
      ...
      <div className="px-6 py-4 bg-tiktok-gray/30 border-t border-tiktok-gray flex gap-3">
        <button
          ...
          className="flex-1 flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white py-2.5 px-4 rounded-lg font-medium transition-colors disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={loading === suggestion.id}
          className="flex items-center justify-center gap-2 bg-tiktok-gray hover:bg-tiktok-gray/70 text-white py-2.5 px-4 rounded-lg font-medium transition-colors disabled:opacity-50"
        >
          <X className="w-4 h-4" />
          Skip
        </button>
...
export default function QueuePage() {
  ...
  }, [status, filter, fetchSuggestions]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white mb-1">AI Suggestions</h1>
          <p className="text-gray-400">
            Review AI-generated product opportunities from trend analysis
          </p>
        </div>
        <button
          onClick={fetchSuggestions}
          disabled={loading}
          className="flex items-center gap-2 px-4 py-2 bg-tiktok-cyan text-black rounded-lg hover:bg-tiktok-cyan/90 transition-colors font-medium disabled:opacity-50"
        >
      ...
      {/* Filter tabs */}
      <div className="flex gap-2 bg-tiktok-dark rounded-xl p-1.5 border border-tiktok-gray w-fit">
      ...
      {loading ? (
        ...
        <div className="bg-tiktok-dark rounded-xl border border-tiktok-gray p-12 text-center">
          ...
          <p className="text-gray-400 mb-6 max-w-md mx-auto">
            {filter === "pending"
              ? "Run trend ingestion from the Discover page to get AI-powered product suggestions."
